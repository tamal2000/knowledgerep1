...
time_history, metric_history_splits, metric_history_backtracks = main(super_hard, 1,0,0)

with open('time_history_DLIS_SHard.txt', 'w') as file:
    file.write(json.dumps(time_history))
with open('metric_history_DLIS_splits_SHard.txt', 'w') as file:
    file.write(json.dumps(metric_history_splits))
with open('metric_history_DLIS_backtracks_SHard.txt', 'w') as file:
